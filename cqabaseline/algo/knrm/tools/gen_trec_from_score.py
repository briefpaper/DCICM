...
if __name__ == '__main__':
    ...
    parser.add_argument("score_file", help="K-NRM output score file", type=argparse.FileType('r', encoding="utf-8"))
    parser.add_argument("trec_org_file", help="must in the same order as score_file", type=argparse.FileType('r', encoding="utf-8"))
